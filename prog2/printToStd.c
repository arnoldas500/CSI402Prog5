...
void printToStd(FILE * input_File){
  ...
  //function reads in data from binary file stores info from the file
  //and compares the min and max length of the strings passed in
  //and the min and max integer numbers from the binary file 
  //and prints everything to standard output
